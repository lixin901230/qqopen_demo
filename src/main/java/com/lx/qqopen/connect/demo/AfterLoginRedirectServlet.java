package com.lx.qqopen.connect.demo;
...
public class AfterLoginRedirectServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -5707622286590570188L;
...
//                做一些数据统计工作
                ...
                out.println("<span style='font-size:30px;'>欢迎你进入李鑫的腾讯开放平台——》qq互联——》qq登录测试网站，代号为 " + openID + " 的用户!</span>");
